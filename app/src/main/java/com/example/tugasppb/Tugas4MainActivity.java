...
public class Tugas4MainActivity extends AppCompatActivity {
    // Var Declaration
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tugas4_main);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (id == R.id.buttonSave) {
                        Tugas4MainActivity.this.simpan();
                    }
                    else if (id == R.id.buttonGetAllData) {
                        Tugas4MainActivity.this.getData();
                    }
                    else if (id == R.id.buttonUpdate) {
                        Tugas4MainActivity.this.update();
                    }
                    else if (id == R.id.buttonDelete) {
                        Tugas4MainActivity.this.delete();
                    }
                }
